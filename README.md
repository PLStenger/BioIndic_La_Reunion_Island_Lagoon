# BioIndic_La_Reunion_Island_Lagoon
BioIndic La Reunion Island Lagoon - UMR Entropie Project
...
First, open your terminal. Then, run these two command lines :
    ...
    git clone https://github.com/PLStenger/BioIndic_La_Reunion_Island_Lagoon.git
